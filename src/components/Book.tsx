...
export default function Book() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const searchWord = randomWords();
    console.log(searchWord)
    const randIndex = Math.floor(Math.random() * 50)
    fetch(`https://www.googleapis.com/books/v1/volumes?q=${searchWord}&startingIndex=${randIndex}&key=AIzaSyCgGlkvNQgkSXMQSXdnenB2EoCnaAG2Z9c`)
